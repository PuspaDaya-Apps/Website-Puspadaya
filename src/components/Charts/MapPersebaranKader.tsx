...
const MapPersebaranKader: React.FC = () => {
  ...
  useEffect(() => {
    const mapInstance = L.map("map-persebaran-desa").setView(banyuwangiView, 10); // Inisialisasi peta dengan koordinat Banyuwangi
    ...
    <div className="">
      <div className="mb-10 flex justify-between">
        <div className="">
          ...
          Peta Pesebaran Kader Aktif dan Tidak Aktif
          </h1>
          <p className="text-normal text-dark">
          Menampilkan peta pesebaran kader aktif dan tidak aktif
          </p>
        </div>
        <div className="w-fit">
          <Dropdown
      ...
      <div id="map-persebaran-desa" style={{ height: "100vh", width: "100%", zIndex: 1 }} />
    </div>
  );
};
