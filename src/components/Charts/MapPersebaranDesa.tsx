...
const MapPersebaranDesa: React.FC = () => {
  ...
  useEffect(() => {
    const mapInstance = L.map("map-persebaran-desa-wilayah").setView(banyuwangiView, 10); // Inisialisasi peta dengan koordinat Banyuwangi
  ...
  const popupContent = (feature: any) => {
    ...
    return `
      <div>
        ...
        <p><strong>Jumlah Desa:</strong> 124</p>
        <p><strong>Jumlah Posyandu:</strong> 589</p>
        <p><strong>Jumah Kader:</strong> 1092</p>
      </div>
    `;
  };
  useEffect(() => {
    ...
    <div className="">
      <div className="mb-10 flex justify-between">
        <div className="">
          ...
          Peta Pesebaran Desa Berdasarkan Wilayah
          </h1>
          <p className="text-normal text-dark">
          Menampilkan peta pesebaran desa berdasarkan wilayah
          </p>
        </div>
        <div className="w-fit">
          <Dropdown
      ...
      <div id="map-persebaran-desa-wilayah" style={{ height: "100vh", width: "100%", zIndex: 1 }} />
    </div>
  );
};

export default MapPersebaranDesa;
