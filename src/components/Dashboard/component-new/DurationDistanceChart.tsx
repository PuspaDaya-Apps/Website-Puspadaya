    ...
    <div className="space-y-6 p-4 md:p-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="rounded-lg bg-indigo-50 p-4 text-center dark:bg-indigo-900/20">
              <p className="text-2xl font-bold text-indigo-600 dark:text-indigo-300">
                {
                  kader.laporan.jumlah_balita_hadir_per_kompetensi
                    .total_hadir_balita
                }
              </p>
            ...
            <div className="rounded-lg bg-emerald-50 p-4 text-center dark:bg-emerald-900/20">
              <p className="text-2xl font-bold text-emerald-600 dark:text-emerald-300">
                {
                  kader.laporan.jumlah_ibu_hamil_hadir_per_kompetensi
                    .total_ibu_hamil
                }
              </p>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div className="rounded-xl bg-white p-6 shadow-md dark:bg-gray-dark">
          ...
          {/* Legenda Kustom untuk Grafik Kehadiran */}
          <div className="mt-4 flex justify-center">
            <div className="flex flex-wrap items-center justify-center gap-4">
              <div className="flex items-center">
                <div className="h-4 w-4 rounded bg-[#4f46e5]"></div>
          ...
          <div className="space-y-4 lg:col-span-1">
            ...
            <div className="rounded-lg bg-violet-50 p-4 dark:bg-violet-900/20">
              ...
              <p className="mt-2 text-sm text-violet-600 dark:text-violet-400">
                Waktu yang dihabiskan untuk kunjungan ke rumah keluarga
              </p>
            </div>
          ...
          <div className="flex h-80 flex-col justify-between lg:col-span-2">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart
                ...
                margin={{ top: 20, right: 30, left: 20, bottom: 40 }} // lebih rapat bawahnya
              >
                <CartesianGrid strokeDasharray="3 3" stroke="#e5e7eb" />
                <XAxis
                  dataKey="name"
                  ...
                  angle={-45}
                  textAnchor="end"
                  height={60} // lebih kecil supaya legend bisa naik
                />
                <YAxis stroke="#6b7280" tick={{ fill: "#6b7280" }} />
                <Tooltip
