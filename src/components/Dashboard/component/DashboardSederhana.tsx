      ...
      <div className={`${highContrast ? "bg-white border-4 border-black" : "bg-white"} rounded-xl p-6 shadow-md`}>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <button
            ...
            className="flex items-center justify-center gap-3 rounded-lg bg-blue-600 px-6 py-4 text-white hover:bg-blue-700 transition"
          >
            <svg className="h-8 w-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z" />
            </svg>
            <span className={`${getFontSize("medium")} font-semibold`}>📄 Cetak Laporan</span>
          </button>
          <button
            onClick={onWhatsAppReport}
            className="flex items-center justify-center gap-3 rounded-lg bg-green-600 px-6 py-4 text-white hover:bg-green-700 transition"
          >
            ...
            <span className={`${getFontSize("medium")} font-semibold`}>📱 Kirim Laporan WhatsApp</span>
          </button>
        </div>
      </div>
    </div>
