...
import {
  ...
  SvgIconLoveBlue,
  SvgIconLoveOrange,
  SvgIconOrangTuaTidakMemilikiKK,
...
import ChartPerhitunganSkdn from "../Charts/ChartPerhitunganSkdn";
import ChartPerhitunganIbuHamil from "../Charts/ChartPerhitunganIbuHamil";
import CountingCardDesa from "../Card/CountingCardDesa";
