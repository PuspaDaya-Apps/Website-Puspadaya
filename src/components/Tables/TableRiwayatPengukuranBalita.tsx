...
const TableRiwayatPengukuranBalita: React.FC = () => {
  return (
    <div className="container mx-auto">
      <div className="card overflow-hidden rounded-lg bg-white p-4 shadow-md">
        <div className="mb-6 flex flex-col justify-between md:flex-row md:items-center">
          <div className="md:mb-0">
            <h2 className="pb-1 text-2xl font-bold text-black">Riwayat Pengukuran Balita</h2>
            <p className="text-sm font-light text-gray-5">Data belum tersedia dari API.</p>
          </div>
        </div>
        ...
        <div className="rounded-xl border border-dashed border-red-300 bg-red-50 p-6 text-red-700">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="font-semibold">Data riwayat pengukuran balita tidak tersedia</p>
