...
const KinerjaPosyanduPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6 p-4 sm:p-6">
      {/* Header */}
      <div className="relative mt-6 overflow-hidden rounded-2xl bg-gradient-to-r from-blue-600 via-blue-700 to-indigo-800 p-6 shadow-xl dark:from-blue-800 dark:via-blue-900 dark:to-indigo-950 sm:p-8">
        {/* Background Pattern */}
        <div className="absolute inset-0 opacity-10">
          <div className="absolute -top-24 -right-24 h-64 w-64 rounded-full border-4 border-white/20"></div>
          <div className="absolute -bottom-16 -left-16 h-40 w-40 rounded-full border-4 border-white/20"></div>
        </div>
        
        <div className="relative flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-start gap-4">
            {/* Icon */}
            <div className="flex h-16 w-16 flex-shrink-0 items-center justify-center rounded-2xl bg-white/10 backdrop-blur-sm shadow-lg">
            ...
            <div>
              ...
              <div className="mt-4 flex flex-wrap gap-4">
                <div className="flex items-center gap-2 rounded-full bg-white/10 px-3 py-1.5 backdrop-blur-sm">
                  ...
                  <div>
                    <p className="text-xs text-blue-100">Total Posyandu</p>
                    <p className="text-lg font-bold text-white">{posyanduPerformanceData.length}</p>
                  </div>
                </div>
                <div className="flex items-center gap-2 rounded-full bg-white/10 px-3 py-1.5 backdrop-blur-sm">
                  <span className="text-2xl">⭐</span>
                  <div>
                    <p className="text-xs text-blue-100">Rata-rata Skor</p>
                    <p className="text-lg font-bold text-white">{avgScore}/100</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <Link
            href="/"
            className="group flex items-center justify-center gap-2 rounded-xl bg-white/10 px-5 py-3 text-sm font-medium text-white backdrop-blur-sm shadow-lg transition-all hover:bg-white/20 hover:shadow-xl hover:scale-105"
          >
